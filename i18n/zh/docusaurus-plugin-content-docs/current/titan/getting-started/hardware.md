...
Titan 板载两个 DDR4 插槽，支持 DDR4 UDIMM，可安装一条或两条内存。使用两条内存时，建议选择规格一致的内存条，以获得更好的兼容性。当前验证过的 DDR4 列表请参考：[内存支持列表](https://milkv.io/zh/docs/titan/getting-started/memory)
