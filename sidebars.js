const sidebars = {
  duo: [
    ...
    },
    {
      ...
      items: ["duo/low-level-dev/mipi-dsi"],
    },
    {
      type: "category",
      label: "🧰 Resources",
    ...
    },
    {
      ...
      items: ["duo/io-board/usb-ethernet-iob", "duo/io-board/duos-poe-hat"],
    },
    {
      type: "category",
      label: "📷 Camera",
      ...
      items: ["duo/camera/gc2083", "duo/camera/tuning", "duo/camera/usb"],
    },
    {
      type: "category",
      label: "📺 Accessories",
  ...
  pioneer: [
    ...
    },
    {
      ...
      items: ["pioneer/development/kernel"],
    },
    "pioneer/faq",
  ],
  mars: [
    ...
    "mars/support-list",
    {
      ...
      link: {
        ...
        description:
          "The Mars Compute Module is a System on Module (SoM) based on a the StarFive JH7110 System on Chip (SoC) integrates the Central Process Unit (CPU), Power Management Unit (PMU), DRAM memory, flash storage and wireless connectivity (WiFi 5 and BT 5.2) in a small form factor of just 55mm x 40mm.",
      ...
      items: [
        ...
        "mars/compute-module/update-eeprom",
        {
          ...
          items: ["mars/compute-module/resources/images"],
        },
      ],
    },
  ],
  meles: [
    ...
    "meles/overview",
    {
      ...
      items: ["meles/getting-started/boot", "meles/getting-started/setup"],
    },
    {
      type: "category",
      ...
      items: ["meles/hardware/meles-main-board"],
    },
    {
      type: "category",
      label: "🖥️ OS Usage",
      ...
      items: ["meles/os-usage/revyos", "meles/os-usage/ros2"],
    },
    {
      type: "category",
    ...
    },
    {
      ...
      items: ["meles/low-level-development/build-revyos"],
    },
    {
      type: "category",
    ...
    },
    {
      ...
      items: [
        "megrez/development-guide/kvm",
        {
          ...
          items: [
            "megrez/development-guide/ENNP-SDK/introduction",
            "megrez/development-guide/ENNP-SDK/esquant",
            "megrez/development-guide/ENNP-SDK/esaac",
            "megrez/development-guide/ENNP-SDK/essim",
            "megrez/development-guide/ENNP-SDK/es_run_model",
            "megrez/development-guide/ENNP-SDK/yolov3",
          ],
        },
        {
          type: "category",
          label: "NPU Runtime Sample Code",
          collapsed: false,
          link: {
            title: "NPU Runtime Sample Code",
            description: " ",
          },
          items: [
